...
abstract: |
  This Manuscript format for [Quarto](http://quarto.org) is influenced by the design and typography of Edward Tufte’s books and the _Tufte LaTeX_ handout template.  This document aims to be at once a demonstration of the features of the _Tufte Inspired_ manuscript format and a guide to their use.
author: 
  - name: "Tufte Inspired Developers"
    email: github.com/fredguth/tufte-inspired
toc: true
open-graph: true
site-url: https://fredguth.github.io/tufte-inspired/
repo-url: https://github.com/fredguth/tufte-inspired/
...
This document demonstrates the use of a number of advanced page layout features to produce an attractive and usable document inspired by the Tufte handout style and the use of Tufte's styles in RMarkdown documents @xie2018[dy.-8em].

::: {.column-margin dy=-14.5cm dx=1cm}

![Edward R. Tufte, godfather of charts, slayer of slide decks](/Images/et_midjourney_transparent.png){width=80%}
